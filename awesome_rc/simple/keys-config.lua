...
--                       awful.button({ }, 3, client_menu_toggle_fn()),
  ...
  globalkeys = awful.util.table.join(
      awful.key({ args.modkey,           }, "s",      hotkeys_popup.show_help,
      ...
      awful.key({ args.modkey,           }, "w", function () mymainmenu:show() end,
                {description = "show main menu", group = "awesome"}),

      -- Layout manipulation
      -- awful.key({ args.modkey,			  }, "Tab", client_menu_toggle_fn()),
      ...
      awful.key({ args.modkey, "Control" }, "j", function () awful.screen.focus_relative( 1) end,
                {description = "focus the next screen", group = "screen"}),
      awful.key({ args.modkey, "Control" }, "k", function () awful.screen.focus_relative(-1) end,
  ...
  self.clientkeys = awful.util.table.join(
      ...
      awful.key({ args.modkey,           }, "o",      function (c) c:move_to_screen()               end,
